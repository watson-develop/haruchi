 ...
 * 숙련 사실 자체를 저장하는 쪽(Phase 2)으로 간다.
 *
 * inverse 태그(inverse-add·inverse-sub)도 여기서 함께 이력이 쌓이지만,
 * Phase 1에서는 이 상태를 읽는 곳이 없다 — openTags·composeSheet 모두 VERTICAL_ORDER만
 * 본다. □ 채우기는 고정 개수로 출제되며 숙련도에 따라 조절되지 않는다. Phase 2에서 배선.
 */
